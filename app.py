...
with col_title:
    ...
    <div style='margin-top:8px;'>
      <span class='hero-badge' style='background:#dcfce7;color:#166534;'>🏆 InsurTech NY Winner</span>
...
with col_badge:
    ...
    <div style='background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;
      ...
      <div style='font-size:11px;color:#6b7280;margin-top:4px;'>Log 5 of 8 complete</div>
    </div>
    """, unsafe_allow_html=True)
...
<div class='log-progress'>
  <div style='font-size:12px;font-weight:600;color:#6b7280;margin-bottom:8px;'>PLATFORM BUILD PROGRESS — 5 of 8 LOGS COMPLETE</div>
  ...
  <span class='log-step' style='background:#dcfce7;color:#166534;'>● Log 6: Validation</span>
...
with n3:
    st.markdown("""<div class='nav-card'>
      ...
      <div class='nav-desc'>Every fraud flag explained. Feature importance, per-claim signal breakdown, and SHAP explainability (Log 7).</div>
...
with r2:
    ...
    <div class='insight-card'>
      ...
      investigator sign-off. Explainable fraud drivers are shown for every decision.
      Validated by insurance professionals in Log 6.
    </div>
    """, unsafe_allow_html=True)
